 ...
 * @author horusblack
 */
public class Jf_CargarXmlManual extends javax.swing.JFrame {

    private final javax.swing.JTable jTableEjemplo;
    private final javax.swing.JScrollPane jScrollPane1;

    public Jf_CargarXmlManual() {
        initComponents();
        ...
        jTableEjemplo.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (jTableEjemplo.getModel().getColumnClass(columna).equals(JButton.class)) {
                    JOptionPane.showMessageDialog(rootPane, "Listo para continuar");
                }
            }
        });
...
//            java.util.logging.Logger.getLogger(Jf_CargarXmlManual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            new Jf_CargarXmlManual().setVisible(true);
//        });
//    }
